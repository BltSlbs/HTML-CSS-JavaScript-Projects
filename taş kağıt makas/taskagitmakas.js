const game = () => {
    ...
    const playMatch = () => {
      ...
      const computerOptions = ["Taş", "Kağıt", "Makas"];
      options.forEach(option => {
        option.addEventListener("click", function() {
          ...
          setTimeout(() => {
            ...
            playerHand.src = `./resimler/${this.textContent}.png`;
    ...
    const compareHands = (playerChoice, computerChoice) => {
      ...
      if (playerChoice === "tas") {
        if (computerChoice === "makas") {
          winner.textContent = "Oyuncu Kazandı";
          pScore++;
          updateScore();
          return;
        } else {
          winner.textContent = "Bilgisayar Kazandı";
          cScore++;
          updateScore();
          return;
        }
